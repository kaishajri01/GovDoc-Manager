...
public class PdfExporterService {
    ...
    public void createPdfPermis(Long id) {
        ...
        String filePdf = "C:/Users/LENOVO/Desktop/" + n + "PermisPdf.pdf";
        try {
    ...
    public void createPdfCin(Long id) {
        ...
        String n = user1.getFirstName();
        String filePdf = "C:/Users/LENOVO/Desktop/" + n + "CinPdf.pdf";
        try {
    ...
    public void createPdfDiplome(Long id) {
        ...
        String n = user1.getFirstName();
        String filePdf = "C:/Users/LENOVO/Desktop/" + n + "DiplomePdf.pdf";
        try {
    ...
    public void createPdfNaissance(Long id) {
        ...
        String n = user1.getFirstName();
        String filePdf = "C:/Users/LENOVO/Desktop/" + n + "BirthPdf.pdf";
                try {
                    PdfWriter writer = new PdfWriter(filePdf);
                    PdfDocument pdfDoc = new PdfDocument(writer);
                    Document document = new Document(pdfDoc);
    ...
    public void createPdfMariage(Long id) {
                ...
                String n = user1.getFirstName();
                String filePdf = "C:/Users/LENOVO/Desktop/" + n + "MariagePdf.pdf";
                try {
                    PdfWriter writer = new PdfWriter(filePdf);
                    PdfDocument pdfDoc = new PdfDocument(writer);
                    Document document = new Document(pdfDoc);
